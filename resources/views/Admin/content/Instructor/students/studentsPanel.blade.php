                            ...
                            <div class="card-body px-0">
                                <div class="table-responsive">
                                    <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{ asset('assets/images/avatar/man-1.png') }}" alt="profile"></td>
                                                <td>Anna Sthesia</td>
                                                <td>(760) 756 7568</td>
                                                ...
                                                <td>
                                                    <div class="flex align-items-center list-user-action">
                                                        ...
                                                        <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="modal" data-bs-target="#infoModal" title="Edit">
  ...
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="infoModalLabel">Editar Usuario</h5>
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="mb-4">
                ...
                <div class="d-flex">
                  <button class="btn btn-primary me-2 px-3" disabled>Upload</button>
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="text" class="form-control" value="Bill Dabear" disabled>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="form-label">Phone</label>
                  <input type="tel" class="form-control" value="+55 2563 456 589" disabled>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="form-label">Email</label>
                  <input type="email" class="form-control" value="billdabear@gmail.com" required>
                </div>
                <div class="col-md-6 mb-3">
                  <label class="form-label">Country</label>
                  <input type="text" class="form-control" value="Brazil" disabled>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <textarea cols="30" rows="4" class="form-control" disabled>This user has been active since 13 days with PERENCO MEXICO.</textarea>
                </div>
              </div>
