...
<body >
                        ...
                        <ul class="sub-nav collapse" id="sidebar-project" data-bs-parent="#sidebar-parent">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('projectsAdmin', 'projectsAdmin.details') ? 'active' : '' }}"
                                    ...
                                    <span class="item-name">{{ __('Projects list') }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('studentsList') ? 'active' : '' }}"
                                    ...
                                    <span class="item-name">{{ __('Students list') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
    ...
    @if(request()->is('catalogs'))
        <script src="{{ asset('js/Admin/Catalogs/catalogs.js') }}?v=1.35"></script>
    @endif
    @if(request()->is('math'))
    ...
    @if (Route::currentRouteName() === 'projectsAdmin.details')
        <script src="{{ asset('js/Admin/Project/details.js') }}?v=1.39"></script>
    @endif
    @if(request()->is('roles'))
