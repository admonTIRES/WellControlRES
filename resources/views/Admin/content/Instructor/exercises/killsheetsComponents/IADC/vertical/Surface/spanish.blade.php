...
<div class="container-iadc-v">
    ...
    <div class="well-diagram-iadc-v">
        <div class="section" style="position: absolute; left:4.2vw; ">
            ...
            <div class="label-iadc-v" style=" border: 0.1vw solid #000; min-width: 100%; background: #b3b3b3;  font-size:0.7vw; padding: 0.1vw 0 0.3vw 0; margin-top:3.7vw; font-family: 'Calibri', Helvetica, Arial, sans-serif;"><strong> Revestimiento MD </strong><input class="input-number-data-well" type="number"> <br><strong>Revestimiento TVD</strong><input class="input-number-data-well" type="number" style="padding: 0; width: 2vw;"></div>
            <div class="label-iadc-v" style=" border: 0.2vw solid #FFC000;min-width: 100%;background: #fff;  font-size:0.66vw; padding: 0.1vw 0 0.3vw 0; margin-top:3.5vw; font-family: 'Calibri', Helvetica, Arial, sans-serif;"><strong>Longitud DP en agujero abierto</strong><br> <input class="input-number-data-well" type="number" style="padding: 0; width: 5vw;"> <br> <strong>(Agujero revestido MD, Longitud DC-MD-Longitud HWDP)</strong> </div>
            <div class="label-iadc-v" style=" border: 0.2vw solid #548235;min-width: 100%; background: #fff;  font-size:0.7vw; padding: 0.1vw 0 0.3vw 0; margin-top:11.2vw; font-family: 'Calibri', Helvetica, Arial, sans-serif;"><strong>Longitud HWDP</strong><br> <input class="input-number-data-well" type="number" style="padding: 0; width: 5vw;"> </div>
            <div class="label-iadc-v" style=" border: 0.2vw solid #7030A0;min-width: 100%; background: #fff;  font-size:0.7vw; padding: 0.1vw 0 0.3vw 0; margin-top:10vw; font-family: 'Calibri', Helvetica, Arial, sans-serif;"><strong>Longitud DC</strong><br> <input class="input-number-data-well" type="number" style="padding: 0; width: 5vw;"> </div>
