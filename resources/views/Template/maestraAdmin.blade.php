        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="collapse navbar-collapse" id="sidebar-parent">
                ...
                <a class="nav-link {{ request()->routeIs('dashboardInstructor') ? 'active' : '' }}" aria-current="page" href="{{ route('dashboardInstructor') }}">
                            ...
                            <span class="item-name">Dashboard Instructor</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-student" role="button" aria-expanded="false" aria-controls="sidebar-student">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-student" data-bs-parent="#sidebar-parent">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('students') ? 'active' : '' }}" aria-current="page" href="{{ route('students') }}">
                                    <i class="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('asignaments') ? 'active' : '' }}" aria-current="page" href="{{ route('asignaments') }}">
                                    <i class="icon">
                                    ...
                                    <span class="item-name">Asignación</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-exercise" role="button" aria-expanded="false" aria-controls="sidebar-exercise">
                            ...
                            <span class="item-name">Ejercicios</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                        ...
                        <ul class="sub-nav collapse" id="sidebar-exercise" data-bs-parent="#sidebar-parent">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('exercises') ? 'active' : '' }}" aria-current="page" href="{{ route('exercises') }}">
                                    <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('catalogs') ? 'active' : '' }}" aria-current="page" href="{{ route('catalogs') }}">
                            ...
                            <span class="item-name">Catálogos</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('home') ? 'active' : '' }}" aria-current="page" href="{{ route('home') }}">
                            ...
                            <span class="item-name">Dashboard Admin</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-parent">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('enterprise') ? 'active' : '' }}" aria-current="page" href="{{ route('enterprise') }}">
                                    <i class="icon">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('individual') ? 'active' : '' }}" aria-current="page" href="{{ route('individual') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> A </i>
                                    <span class="item-name">Individuales</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('membership') ? 'active' : '' }}" aria-current="page" href="{{ route('membership') }}">
                                <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> U </i>
                                    <span class="item-name">Membresias</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-auth" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            ...
                            <span class="item-name">Accesos</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-parent">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('instructors') ? 'active' : '' }}" aria-current="page" href="{{ route('instructors') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Instructores</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('external') ? 'active' : '' }}" aria-current="page" href="{{ route('external') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> C </i>
                                    <span class="item-name">Externos</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('roles') ? 'active' : '' }}" aria-current="page" href="{{ route('roles') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('recovery') ? 'active' : '' }}" aria-current="page" href="{{ route('recovery') }}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Recuperar contraseña</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('reports') ? 'active' : '' }}" aria-current="page" href="{{ route('reports') }}">
                            <i class="icon">
                    ...
                    <div class="card ms-3 me-3 bg-white sidebar-footer-contain">
                        <div class="card-body">
                            <div class="sidebarbottom-content">
                                ...
                                <h5 class="mt-3"><span class="text-secondary">Be more</span> sssss <span class="text-secondary">with</span> Pro Feature</h5>
                            </div>
                        </div>
                    </div>
                </div>
