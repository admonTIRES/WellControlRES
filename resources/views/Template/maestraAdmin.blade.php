...
<body >
            ...
            <div class="collapse navbar-collapse" id="sidebar-parent">
                <ul class="navbar-nav iq-main-menu py-4">
                   @if( (session('ROLES_USER')['logistica'] ?? false)
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-project" role="button"
                            aria-expanded="false" aria-controls="sidebar-project">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <li class="nav-item instructorNav">
                        <a class="nav-link {{ request()->routeIs('dashboardInstructor') ? 'active' : '' }}"
                            aria-current="page" href="{{ route('dashboardInstructor') }}">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                                        d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z"
                    ...
                    <li class="nav-item instructorNav">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-projectsAdmin" role="button"
                            aria-expanded="false" aria-controls="sidebar-projectsAdmin">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M11.9488 14.54C8.49884 14.54 5.58789 15.1038 5.58789 17.2795C5.58789 19.4562 8.51765 20.0001 11.9488 20.0001C15.3988 20.0001 18.3098 19.4364 18.3098 17.2606C18.3098 15.084 15.38 14.54 11.9488 14.54Z"
                            ...
                            <span class="item-name">{{ __('Assigned projects') }}</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-projectsAdmin" data-bs-parent="#sidebar-parent">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('projectsInstructor') ? 'active' : '' }}"
                                    aria-current="page" href="{{ route('projectsInstructor') }}">
                                    <i class="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item instructorNav">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-exercise" role="button"
                            aria-expanded="false" aria-controls="sidebar-exercise">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4"
                        ...
                        <ul class="sub-nav collapse" id="sidebar-exercise" data-bs-parent="#sidebar-parent">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('exercises') ? 'active' : '' }}"
                                    aria-current="page" href="{{ route('exercises') }}">
                                    <i class="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('killsheets') ? 'active' : '' }}"
                                    aria-current="page" href="{{ route('killsheets') }}">
                                    <i class="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item"
                                            href="../dashboard/app/user-privacy-setting.html">Ajustes</a></li>
                                    <li>
    ...
    @if(request()->is('catalogs'))
        ...
        <script src="{{ asset('js/Admin/Catalogs/catalogs.js') }}?v=1.19"></script>
    @endif
    @if(request()->is('math'))
    ...
    @if(request()->is('projectsAdmin'))
        <script src="{{ asset('js/Admin/Project/project.js') }}?v=1.48"></script>
    @endif
    ...
    @if (Route::currentRouteName() === 'projectsAdmin.details')
        <script src="{{ asset('js/Admin/Project/details.js') }}?v=1.27"></script>
    @endif
    @if(request()->is('roles'))
