...
// Función para alternar los filtros según el tipo de período (gráfica apilada)
...
@endsection
@section('scripts')
 <script src="{{ asset('js/Admin/Dashboard/dashboard.js') }}?v=1.3"></script>
