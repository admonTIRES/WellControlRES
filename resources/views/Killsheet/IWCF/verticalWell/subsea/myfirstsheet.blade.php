...
<div class="info-container">
    ...
    <div id="hoja-matar-card" class="hoja-card d-none">
        <div class="hoja-header" id="hoja-drag">
            <button id="cerrar-hoja" class="btn-close">×</button>
        </div>

        <div class="hoja-body" id="hoja-content">
        </div>
    </div>
    ...
    <div class="hoja-fab-wrapper">
        ...
        <div id="btn-hoja-fab" class="hoja-fab">
            📄
        </div>
    </div>
    ...
    <div class="container-iwcf-v-sur" style="background-color: #e0e0e0;">

        <div class="header-iwcf-v-sur">
            <div class="header-left-iwcf-v-sur" style="background-color: #e0e0e0;">
            ...
            <div class="header-right-iwcf-v-sur" style="background-color: #e0e0e0;">
            </div>
        </div>
        ...
        <table class="iwcf-volumen-header" style="background-color: #e0e0e0;">
            <tr>
        ...
        <div class="footer-iwcf-v-sur" style="text-align: right; font-size: 10px; margin-top: 10px;background-color: #e0e0e0;">

        </div>
    </div>

    <!-- Page 2 -->
    <div class="container-iwcf-v-sur" style="margin-top: 20px; background-color: #e0e0e0;">
        <div class="header-iwcf-v-sur">
            <div class="header-left-iwcf-v-sur" style="background-color: #e0e0e0;">
                <div class="title-iwcf-v-sur">International Well Control Forum</div>
        ...
        <div class="kill-mud-box-iwcf-v-sur" style="background-color: #e0e0e0;">
            ...
            <style>
                ...
                #btn-finalizar-hoja:hover {
                    background-color: #218838;
                    transform: scale(1.03);
                }

                #btn-finalizar-hoja:active {
